...
{% if grains['osmajorrelease'][0] == '5' %}
  {% set pkg = {
    'key': 'salt://epel/files/A4D647E9.txt',
...
{% elif grains['osmajorrelease'][0] == '6' %}
  {% set pkg = {
    ...
    'rpm': 'http://download.fedoraproject.org/pub/epel/6/i386/Packages/e/epel-release-6-8.noarch.rpm',
  } %}
{% elif grains['osmajorrelease'][0] == '7' %}
  {% set pkg = {
    'key': 'salt://epel/files/RPM-GPG-KEY-EPEL-7',
    'key_hash': 'md5=58fa8ae27c89f37b08429f04fd4a88cc',
    'rpm': 'http://download.fedoraproject.org/pub/epel/7/x86_64/Packages/e/epel-release-7-5.noarch.rpm',
  } %}
